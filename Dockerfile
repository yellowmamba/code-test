...
MAINTAINER Michael Wu <wujianfei871015@gmail.com>
...
ENTRYPOINT ["php", "processor.php", "redbubble:images-processor"]

CMD ["http://take-home-test.herokuapp.com/api/v1/works.xml", "/output"]